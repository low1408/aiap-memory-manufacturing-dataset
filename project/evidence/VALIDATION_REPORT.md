...
The checks establish internal consistency, lineage, units, availability and selected physical relationships. They do not establish calibration to SK hynix manufacturing distributions, yields or process capability. All records are synthetic. Public product context and engineering assumptions are documented in `SOURCES.md`.
