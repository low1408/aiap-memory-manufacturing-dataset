...
The [client brief](../../problem-statement/helion_semiconductor_client_brief.md) supplies the five procedures, nominal durations, inconclusive rates, four-person Yield Engineering ownership team and independent 1-in-20 audit policy. All other quantities here are synthetic assumptions. The [mock inspection rules](../../helion-design/mock_engineering_inspection_rules.md) remain the exercise's comparator, including their explicitly invented all-seven-mechanism completeness rule. These assumptions do not replace that rule.
...
With the conservative all-seven completeness rule, CT, acoustic, electrical and SEM will often all be required; their once-each cost is $2,720. IR adds $150 only when required or for an independent audit. Reordering those same four procedures does not reduce $2,720 of execution cost. Legitimate benefits must come from changed necessary work, reduced repeat effort or scheduling improvements measured separately, at unchanged diagnostic adequacy.
